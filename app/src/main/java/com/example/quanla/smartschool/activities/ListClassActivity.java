...
public class ListClassActivity extends AppCompatActivity
    ...
    public static final String userKey = "haolt";
...
//            user = SharedPrefs.getInstance().getLoginCredentials().getUsername();
        ...
        DbTeachingSchedule.instance.getAllTeachingSchedule();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_list_class) {
            ...
            TeachingScheduleAdapter teachingScheduleAdapter = new TeachingScheduleAdapter();
            if (DbTeachingSchedule.instance.getTeachingScheduleList() != null) {
                rvClassList.setAdapter(teachingScheduleAdapter);
                rvClassList.setLayoutManager(new GridLayoutManager(this,1));
                DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(this, DividerItemDecoration.VERTICAL);
                rvClassList.addItemDecoration(dividerItemDecoration);
                Toast.makeText(this, "Load completed", Toast.LENGTH_SHORT).show();
